...
public class CargoService {
	 ...
	 * 
	 * @param todosCadastrados traz a lista de todos os cargos cadastrados no arrayList
	 ...
	 */
	public ArrayList<Cargo> cadastrarCargo(ArrayList<Cargo> todosCadastrados, int id, String nomeCargo) {// TODO verificar
	 ...
	 * @param listaCargo Lista que serve para a adição de itens e procurar o id <i>idCargoProcurar</i>
	 ...
	 * @param idCargoProcurar id que serve para procurar o item na lista a ser alterado
